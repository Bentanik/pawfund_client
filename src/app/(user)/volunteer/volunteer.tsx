        ...
        >
            <div className='grid grid-cols-12 gap-8'>
                ...
                <motion.div
                    ...
                    transition={{ duration: 1 }}
                >
                    <span className='text-gray-400 font-semibold text-base'>Love cats and want to help?</span>
                    <h2 className='font-semibold text-4xl text-gray-700'>Volunteers are our lifeblood</h2>
                    <p className='text-gray-600'>
                        People helping people and animals is what Cat Adoption Foundation Incorporated stands for. CAFinc would not exist without its dedicated volunteers, and without them so many cats and kittens would never be rescued from dire circumstances.
                    </p>
                </motion.div>
            </div>
            ...
            >
                <h3 className='w-1/3 mx-auto font-semibold text-xl text-gray-600'>
                    We have all sorts of volunteer roles available, depending on how involved you’d like to be, how much time you have, and even whether you’d like a new furry houseguest (or three!)
                </h3>
            </motion.div>
            ...
            >
                {[
                    ...
                    >
                        <p className='w-1/4 font-semibold text-base text-teal-400'>{item.title}</p>
                        <p className='w-1/2 text-base text-gray-500'>{item.description}</p>
                    </motion.div>
                ))}
            </motion.div>
            ...
            >
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-1">
                            ...
                            <AccordionContent className="text-[#00000076] text-base">
                                The amount of time you can give is entirely up to you and the volunteer role you would like to assist with.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-2">
                            ...
                            <AccordionContent className="text-[#00000076] text-base">
                                No experience is required. You will be given full training and support along the way.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-3">
                            ...
                            <AccordionContent className="text-[#00000076] text-base">
                                Cat Adoption Foundation pays for all vet work including desexing, microchipping, vaccination and medications and surgeries if required. Many volunteers donate food, litter and other basic requirements and this cost is a tax deductible donation. CAFinc can provide these if needed, so your financial commitment is commensurate to your circumstances.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-4">
                            ...
                            <AccordionContent className="text-[#00000076] text-base">
                                Absolutely! What you can give is entirely up to you and many of our volunteers remain supportive of other volunteers while taking a break from their active roles.
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
                ...
                >
                    <p className='text-gray-500 font-medium text-lg'>It’s a great feeling to be able to give back and help, plus you get to cuddle kitties – it’s a win win!</p>
                    <h5 className='font-semibold'>- Kelly, volunteer</h5>
                    <p className='text-gray-500 font-medium text-lg'>I finally found my purpose in life; helping frightened kitties trust again. There is nothing more heartwarming than flicking that switch, then finding them loving homes.</p>
