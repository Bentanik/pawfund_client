        ...
        >
          <div className="p-[10%]">
            ...
            <p className="mt-[70px] ml-[20px]">
              Cat adoption and support events help homeless or abandoned cats
              find loving homes, raise awareness about responsible pet
              ownership, and provide a platform for animal lovers to adopt and
              support cats through donations or volunteering, making a positive
              impact in cat lives.
            </p>
            <div className="w-full border-t mt-[30px]">
              ...
              <p className="mt-10px">
                To learn about policies and other benefits for volunteers,
      ...
      <div className="mt-[20px]">
        <div className="flex gap-[40px] justify-between">
          <div>
            <Select
              value={status}
              onValueChange={(value) => setStatus(value as REQUEST.EventStatus)}
            >
