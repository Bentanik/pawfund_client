...
const EventDetail = ({ eventId }: EventDetail) => {
  ...
  const handleVolunteer = async (data: any) => {
    ...
    try {
      ...
      console.error("Có lỗi xảy ra khi gửi yêu cầu tình nguyện viên:", error);
    }
  };
  ...
  const renderListEvent = () => {
    return eventActivities?.map((item, index) => {
      const numberOfVolunteer = Math.round(
        (item?.activityDTO.numberOfVolunteer / item?.activityDTO.quantity) * 100
      );
            ...
            <AccordionContent className="">
              <div className="border rounded-xl">
                <div className="p-[20px]">
                  ...
                  <div className="flex gap-2 mt-4">
                    <div>Description: </div>
                    <div>{item?.activityDTO.description}</div>
                  </div>
                </div>
              </div>
            </AccordionContent>
        ...
        <div className="p-[20px]">
              ...
              <div className="flex ">
                ...
                <div className="flex-1 bg-[#f5f5f5] h-[500px]">
                  <div className="p-[100px]">
                    ...
                    <h2 className="text-[3rem]">Detail about event</h2>
                    <div className="flex">
                  ...
                  <div className="p-[100px]">
                    ...
                    <div>
                      <div className="flex mt-4 gap-3">
                        ...
                        <div>{event?.eventDTO.branch.name}</div>
                      </div>
                      <div className="flex mt-4 gap-3 ">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div>{event?.eventDTO.branch.phoneNumberOfBranch}</div>
                      </div>{" "}
                      <div className="flex mt-4 gap-3 ">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div>{event?.eventDTO.branch.emailOfBranch}</div>
                      </div>{" "}
                      <div className="flex mt-4 gap-3 ">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="my-[50px]">
            <div className="flex justify-between w-[70%] items-center">
              <h1 className="text-[2rem]">Activities for volunteers</h1>
              <Button className="hover:bg-[#2DD4BF]" onClick={handleOpenPopup}>
                Be come volunteer
              </Button>
            </div>
