...
const ListProccess = [
  ...
  {
    title:
      "Contact our Adoption Counselor to find out more information about the pet.",
  },
  {
  ...
  {
    title:
      "Prepare a corner for your pet, sign the adoption paper and pay an adoption fee.",
  },
  {
    title:
      "Keep us posted on the pet’s new life, especially if an incident happens to receive proper support.",
  },
];
    ...
    return ListProccess.map((item, index) => {
      return (
        <div key={index} className="flex items-center gap-x-3">
          ...
          <p className="flex-1 text-base text-[#6f6f6f]">{item.title}</p>
        </div>
      );
    });
  };
          ...
          <div className="relative z-10 w-9/12 p-20 ml-0">
            <div className="flex flex-col gap-y-4">
              ...
              <p className="text-white text-lg">
                Whether you want to adopt a playmate or a snuggle buddy, the
                cats and kittens for adoption from CAT are ready to join your
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-col gap-y-6">
                <p className="text-base text-[#6f6f6f]">
                  Before deciding to adopt, please ask yourself if you are ready
                  for a lifetime commitment to a pet. There are many things to
                  consider such as financial ability, accommodation as well as
                  mentality (yes, being a parent is never easy). The adoption
                  will also need the mutual agreement between your family and
                  related sides.
                </p>
                <p className="text-base text-[#6f6f6f]">
                ...
                <div className="flex flex-col gap-y-3">
                  <div className="flex items-center gap-x-1">
                    ...
                    <h3 className="text-base text-[#6f6f6f]">Notice</h3>
                  </div>
                  <div className="flex flex-col gap-y-1">
                    {renderListNotice()}
                  </div>
                ...
                <p className="text-base text-[#6f6f6f]">
                  If you can only foster, consider being one of our Volunteers.
                  Find out more information in the Volunteer section.
                </p>
                <p className="text-base text-[#6f6f6f]">
                  Details about our Virtual Adoption Program is available in the
                  bottom banner of this page.
                </p>
              </div>
            </div>
