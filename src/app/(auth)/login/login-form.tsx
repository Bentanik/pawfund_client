            ...
            <div className="w-[70%] px-5 py-4 m-auto">
                ...
                <form className="pt-5 flex flex-col gap-y-4" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex flex-col gap-y-5">
                        <button className={`mt-2 block w-[100%] rounded-md py-2 ${watchEmail !== "" && watchPassword !== "" ? "bg-[#7a3cdd]" : "bg-[#C3B1E1]"}`}>
                            <span className="text-base text-gray-200">Login</span>
                        </button>
                        <div className="flex items-center justify-between gap-3">
                            <div className={`w-[50%] h-1 rounded-full ${watchEmail !== "" && watchPassword !== "" ? "bg-[#7a3cdd]" : "bg-[#C3B1E1]"}`}></div>
