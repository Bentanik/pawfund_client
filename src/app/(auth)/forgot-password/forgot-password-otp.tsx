...
export default function ForgotPasswordOtp({ onSubmit }: ForgotPasswordOtpProps) {
    ...
    return (
        <div>
            ...
            <form className="pt-5 flex flex-col gap-y-4" onSubmit={handleSubmitForm}>
                ...
                <div className="flex flex-col gap-y-5">
                    <button type="submit" className={`mt-2 block w-[100%] rounded-md py-2 ${value !== "" ? "bg-[#7a3cdd]" : "bg-[#C3B1E1]"}`}>
                        <span className="text-base text-gray-200">Submit</span>
                    </button>
                    <div className="flex items-center justify-between gap-3">
                        <div className={`w-[50%] h-1 rounded-full ${value !== "" ? "bg-[#7a3cdd]" : "bg-[#C3B1E1]"}`}></div>
