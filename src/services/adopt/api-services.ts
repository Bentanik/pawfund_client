...
export const rejectAdoptApplication = async (
    body: REQUEST.RejectAdoptionRequest
) => {
    const response = await request<TResponse>(
...
export const updateAdoptApplication = async (
    body: REQUEST.AdoptApplicationRequest
) => {
    const response = await request<TResponse>(
...
export const updateChooseMeetingTime = async (
    body: REQUEST.ChooseMeetingTime
) => {
    const response = await request<TResponse>(
...
export const rejectOutsideAdoption = async (
    body: REQUEST.RejectAdoptionRequest
) => {
    const response = await request<TResponse>(
