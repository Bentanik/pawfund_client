...
const CreateEvent: React.FC<{ eventId: string }> = ({ eventId }) => {
  ...
  const { postCreateEventActivityApi, isPending } =
    usePostCreateEventActivity();
  ...
  const handleCreateEvent = async () => {
    ...
    if (res) {
      addToast({
        type: "success",
        description: "Event activity created successfully!",
      });
      setShowForm(false);
      ...
      addToast({
        type: "error",
        description: "Failed to create event activity",
      });
    }
  };
                ...
                <div className="flex items-center space-x-5">
                  ...
                  <div className="block pl-2 font-semibold text-xl self-start text-gray-700">
                    ...
                    <p className="text-sm text-gray-500 font-normal leading-relaxed">
                      Create your event details below.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="flex flex-col">
                        ...
                        <input
                          ...
                          className="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                          value={startDate}
                          onChange={(e) => handleInputChangeDate(e, setStartDate)}
                        />
                      </div>
                    </div>
                    <div className="flex flex-col">
