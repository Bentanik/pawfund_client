...
export default function StepForm({ setLoading }: StepFormProps) {
  ...
  const handleDonateBanking = () => {
    const formData: REQUEST.TDonateBanking = {
      orderId: 8,
      amount: selectAmount != 0 ? selectAmount : Number.parseInt(customAmount),
      ...
      {step === 0 && (
        <Card>
          <div className="relative p-[20px]">
            <div className=" text-center font-semibold">Choose your amount</div>
          ...
          <CardFooter>
            <Button onClick={handleNextForm} className="hover:opacity-75">
              Next Step
            </Button>
          </CardFooter>
        </Card>
              ...
              <Card className="!border-0">
                <CardHeader>
                  ...
                  <CardDescription className="!mt-[10px]">
                    If you donate in cash, please click the button below for
                    more details.
                  </CardDescription>
                </CardHeader>
                <CardFooter>
            ...
            <TabsContent value="password">
              <Card className="!border-0">
                <CardHeader>
                  ...
                  <CardDescription className="!mt-[10px]">
                    If you donate in banking, please click the button below for
                    more details.
                  </CardDescription>
                </CardHeader>
                <CardFooter>
                  <Button type="button" onClick={handleDonateBanking}>
                    Donate
                  </Button>
                </CardFooter>
              </Card>
